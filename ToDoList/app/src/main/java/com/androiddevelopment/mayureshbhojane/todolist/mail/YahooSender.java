...
public class YahooSender extends Authenticator {

    public static final String YAHOO_COM = "@yahoo.com";
    public static final String YAHOO_CO_IN = "@yahoo.co.in";
    private static final String mailhost = "smtp.mail.yahoo.com";
    ...
    // constructor
    public YahooSender(String emailId, String emailPwd) {
